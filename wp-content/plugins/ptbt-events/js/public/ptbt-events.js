...
jQuery(document).ready(function($){
	...
	var wpajax_url = document.location.protocol + '//' + document.location.host + '/ptbt-events/wp-admin/admin-ajax.php';
	
	// email capture action url
	var email_capture_url = wpajax_url += '?action=ptbte_save_subscription';
	
	$('form#ptbte_register_form').bind('submit',function(){
